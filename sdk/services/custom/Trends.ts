...
/**
 * Api services for the `Trends` model.
 */
@Injectable()
export class TrendsApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Trends` object.)
   * </em>
   */
